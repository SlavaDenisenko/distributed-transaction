...
*/}}
{{- define "transaction-chart.fullname" -}}
...
*/}}
{{- define "transaction-chart.chart" -}}
{{- $root := . -}}
...
Common labels
*/}}
{{- define "transaction-chart.labels" -}}
{{- $root := . -}}
helm.sh/chart: {{ include "transaction-chart.chart" $root }}
{{ include "transaction-chart.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "transaction-chart.selectorLabels" -}}
{{- $root := . -}}
app.kubernetes.io/name: {{ include "transaction-chart.name" $root }}
